...
<form name="frm_select" method="post" action="">
  Tampilkan
  <select class="btn dropdown-toggle span2" name="row_page" onchange="document.forms.frm_select.submit();">
  <option>-- pilih --</option>
  <option value="5" 
  <?php 
...
//Variabel $sql berisi pernyataan SQL retrieve dengan limitasi
        $row = $_POST['row_page'];                        
         ...
         if($res) { ?>
                 <table class="table-bordered table-hover table-striped" border="1" cellpadding="5" cellspacing="1">
        <tr>
                <th>#</th>
            <th width="100">NIM</th>
