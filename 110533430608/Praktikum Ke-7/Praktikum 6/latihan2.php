...
<form name="frm_select" method="post" action="">
  Tampilkan
  <select class="btn dropdown-toggle span2" name="row_page" onchange="document.forms.frm_select.submit();" > <!--value diganti jika di klik submit-->
  <option>-- pilih --</option>
...
//Variabel $sql berisi pernyataan SQL retrieve dengan limitasi
        $row = $_POST['row_page'];                        
         ...
         //menampilkan hasil
         if($res) { ?>
                 <table border="1" cellpadding="5" cellspacing="1" class="table-bordered table-hover table-striped">
        <tr>
                <th>#</th>
            <th width="100">NIM</th>
